...
import { Category, Account, Repeatability } from './types';

export const INITIAL_CATEGORIES: Category[] = [
  { id: '1', name: 'Spesa', icon: 'cart', color: '#8E7C68' },
  { id: '2', name: 'Trasporti', icon: 'car', color: '#A69685' },
  { id: '3', name: 'Casa', icon: 'house', color: '#B8B0A5' },
  { id: '4', name: 'Ristoranti', icon: 'fork.knife', color: '#8E7C68' },
  { id: '5', name: 'Svago', icon: 'play.tv', color: '#D1C8BD' },
  { id: '6', name: 'Salute', icon: 'heart', color: '#A69685' },
];

export const INITIAL_ACCOUNTS: Account[] = [
  { id: 'acc1', name: 'Conto Principale', balance: 1500, type: 'Banca', color: '#3B82F6' },
  { id: 'acc2', name: 'Contanti', balance: 200, type: 'Contanti', color: '#10B981' },
];

export const REPEAT_OPTIONS = Object.values(Repeatability);

// Percorsi SVG ottimizzati per emulare gli SF Symbols originali di iOS
export const CATEGORY_ICON_PATHS: Record<string, string> = {
  ...
  // cup.and.saucer (Caffè/Colazione)
